...
enum opt_code
{
  ...
  /* OPT_Wbidi_chars = 473, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 474,                    /* -Wbidi-chars= */
  ...
  OPT_Wopenmp_simd = 655,                    /* -Wopenmp-simd */
  OPT_Woverflow = 656,                       /* -Woverflow */
  OPT_Woverlength_strings = 657,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 658,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 659,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 660,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 661,            /* -Woverwrite-recursive */
  OPT_Wp_ = 662,                             /* -Wp, */
  OPT_Wpacked = 663,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 664,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 665,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 666,                         /* -Wpadded */
  OPT_Wparentheses = 667,                    /* -Wparentheses */
  OPT_Wpedantic = 668,                       /* -Wpedantic */
  ...
  OPT_Wpoison_system_directories = 677,      /* -Wpoison-system-directories */
  ...
  OPT_fassume_phsa = 885,                    /* -fassume-phsa */
  ...
  OPT_fdiagnostics_escape_format_ = 1012,    /* -fdiagnostics-escape-format= */
  ...
  OPT_fdump_analyzer_feasibility = 1047,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_json = 1048,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1049,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1050,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1051,      /* -fdump-analyzer-supergraph */
  /* OPT_fdump_core = 1052, */               /* -fdump-core */
  OPT_fdump_d_original = 1053,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1054,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1055,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1056,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1057,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1058,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1059,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1060,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1061,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1062, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1063,                   /* -fdump-passes */
  OPT_fdump_scos = 1064,                     /* -fdump-scos */
  OPT_fdump_unnumbered = 1065,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1066,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1067,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1068,                /* -fearly-inlining */
  OPT_felide_constructors = 1069,            /* -felide-constructors */
  OPT_felide_type = 1070,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1071, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1072,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1073,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1074,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1075,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1076,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1077,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1078,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1079,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1080,                /* -fenum-int-equiv */
  OPT_fexceptions = 1081,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1082,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1083,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1084,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1085,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1086,          /* -fextended-identifiers */
  OPT_fextern_tls_init = 1087,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1088,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1089,            /* -fexternal-templates */
  OPT_ff2c = 1090,                           /* -ff2c */
  OPT_ffast_math = 1091,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1092,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1093,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1094,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1095,              /* -ffinite-math-only */
  OPT_ffixed_ = 1096,                        /* -ffixed- */
  OPT_ffixed_form = 1097,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1098,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1099,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1100,                   /* -ffloat-store */
  OPT_ffor_scope = 1101,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1102, */              /* -fforce-addr */
  OPT_fforward_propagate = 1103,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1104,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1105,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1106,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1107,                     /* -ffpe-trap= */
  OPT_ffree_form = 1108,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1109,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1110,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1111,                  /* -ffreestanding */
  OPT_ffriend_injection = 1112,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1113,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1114,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1115,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1116,             /* -ffunction-sections */
  OPT_fgcse = 1117,                          /* -fgcse */
  OPT_fgcse_after_reload = 1118,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1119,                      /* -fgcse-las */
  OPT_fgcse_lm = 1120,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1121,                       /* -fgcse-sm */
  OPT_fgimple = 1122,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1123,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1124,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1125,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1126,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1127,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1128,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1129,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1130,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1131,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1132,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1133,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1134,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1135,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1136,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1137,                  /* -fgo-embedcfg= */
  OPT_fgo_optimize_ = 1138,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1139,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1140,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1141,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1142,                      /* -fgraphite */
  OPT_fgraphite_identity = 1143,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1144,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1145,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1146, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1147, */                    /* -fhelp */
  /* OPT_fhelp_ = 1148, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1149,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1150,                     /* -fhonor-std */
  OPT_fhosted = 1151,                        /* -fhosted */
  OPT_fhuge_objects = 1152,                  /* -fhuge-objects */
  OPT_fident = 1153,                         /* -fident */
  OPT_fif_conversion = 1154,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1155,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1156,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1157,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1158,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1159,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1160,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1161,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1162,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1163,               /* -finit-character= */
  OPT_finit_derived = 1164,                  /* -finit-derived */
  OPT_finit_integer_ = 1165,                 /* -finit-integer= */
  OPT_finit_local_zero = 1166,               /* -finit-local-zero */
  OPT_finit_logical_ = 1167,                 /* -finit-logical= */
  OPT_finit_real_ = 1168,                    /* -finit-real= */
  OPT_finline = 1169,                        /* -finline */
  OPT_finline_arg_packing = 1170,            /* -finline-arg-packing */
  OPT_finline_atomics = 1171,                /* -finline-atomics */
  OPT_finline_functions = 1172,              /* -finline-functions */
  OPT_finline_functions_called_once = 1173,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1174, */           /* -finline-limit- */
  OPT_finline_limit_ = 1175,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1176,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1177,        /* -finline-small-functions */
  OPT_finput_charset_ = 1178,                /* -finput-charset= */
  OPT_finstrument_functions = 1179,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1180,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1181,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1182,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1183,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1184,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1185,                    /* -finvariants */
  OPT_fipa_bit_cp = 1186,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1187,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1188, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1189,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1190,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1191,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1192,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1193, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1194,                    /* -fipa-modref */
  OPT_fipa_profile = 1195,                   /* -fipa-profile */
  OPT_fipa_pta = 1196,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1197,                /* -fipa-pure-const */
  OPT_fipa_ra = 1198,                        /* -fipa-ra */
  OPT_fipa_reference = 1199,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1200,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1201,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1202,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1203, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1204,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1205,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1206,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1207,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1208,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1209,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1210,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1211,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1212,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1213,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1214,              /* -fivar-visibility= */
  OPT_fivopts = 1215,                        /* -fivopts */
  OPT_fjump_tables = 1216,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1217,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1218,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1219,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1220,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1221,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1222,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1223,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1224,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1225,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1226,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1227,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1228,            /* -flarge-source-files */
  OPT_flax_vector_conversions = 1229,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1230,            /* -fleading-underscore */
  OPT_flifetime_dse = 1231,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1232,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1233,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1234,                /* -flinker-output= */
  /* OPT_flive_patching = 1235, */           /* -flive-patching */
  OPT_flive_patching_ = 1236,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1237,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1238,                   /* -flocal-ivars */
  /* OPT_floop_block = 1239, */              /* -floop-block */
  /* OPT_floop_flatten = 1240, */            /* -floop-flatten */
  OPT_floop_interchange = 1241,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1242,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1243, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1244,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1245, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1246,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1247,                     /* -flra-remat */
  OPT_flto = 1248,                           /* -flto */
  OPT_flto_compression_level_ = 1249,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1250, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1251,                /* -flto-partition= */
  OPT_flto_report = 1252,                    /* -flto-report */
  OPT_flto_report_wpa = 1253,                /* -flto-report-wpa */
  OPT_flto_ = 1254,                          /* -flto= */
  OPT_fltrans = 1255,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1256,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1257,             /* -fmacro-prefix-map= */
  OPT_fmain = 1258,                          /* -fmain */
  OPT_fmath_errno = 1259,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1260,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1261,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1262,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1263,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1264,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1265,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1266,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1267,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1268,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1269,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1270,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1271,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1272,                  /* -fmodule-file= */
  OPT_fmodule_header = 1273,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1274,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1275,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1276,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1277,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1278,                   /* -fmodule-only */
  OPT_fmodule_private = 1279,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1280,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1281,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1282,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1283,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1284,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1285,          /* -fmove-loop-invariants */
  ...
  OPT_list = 1685,                           /* -list */
  OPT_mabi_ = 1686,                          /* -mabi= */
  OPT_march_ = 1687,                         /* -march= */
  OPT_mbig_endian = 1688,                    /* -mbig-endian */
  OPT_mbionic = 1689,                        /* -mbionic */
  OPT_mbranch_protection_ = 1690,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1691,                       /* -mcmodel= */
  OPT_mcpu_ = 1692,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1693,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1694,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1695,             /* -mgeneral-regs-only */
  OPT_mglibc = 1696,                         /* -mglibc */
  OPT_mharden_sls_ = 1697,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1698,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1699,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1700,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1701,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1702,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1703,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1704,               /* -moutline-atomics */
  OPT_moverride_ = 1705,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1706,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1707,          /* -msign-return-address= */
  ...
  OPT_mstack_protector_guard_ = 1710,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1711,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1712,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1713,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1714,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1715,             /* -mtrack-speculation */
  OPT_mtune_ = 1716,                         /* -mtune= */
  OPT_muclibc = 1717,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1718,             /* -mverbose-cost-dump */
  OPT_n = 1719,                              /* -n */
  OPT_name_sort = 1720,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1721,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1722,              /* -no-integrated-cpp */
  OPT_no_pie = 1723,                         /* -no-pie */
  OPT_nocpp = 1724,                          /* -nocpp */
  OPT_nodefaultlibs = 1725,                  /* -nodefaultlibs */
  OPT_nolibc = 1726,                         /* -nolibc */
  OPT_nophoboslib = 1727,                    /* -nophoboslib */
  OPT_nostartfiles = 1728,                   /* -nostartfiles */
  OPT_nostdinc = 1729,                       /* -nostdinc */
  OPT_nostdinc__ = 1730,                     /* -nostdinc++ */
  OPT_nostdlib = 1731,                       /* -nostdlib */
  OPT_o = 1732,                              /* -o */

...
class cConfigDobby(cConfig):
    def __init__(self, sanityCheck, rootfs, privileged, crashReporting, append, prevUserName, prevGroupName, swapEnabled, capsGenerationEnabled):
        super(cConfigDobby, self).__init__(sanityCheck, rootfs, privileged, crashReporting, append, prevUserName, prevGroupName, swapEnabled, capsGenerationEnabled)
        self.autodev = False
    ...
    def createLxcConf(self, configNode):
        ...
        cgroup = cCgroupDobby(self.sanityCheck, self.swapEnabled)
        ...
        if not self.rootfs.isRootfsShared():
            ...
            dbus = cDbusDobby(self.rootfs, self.sanityCheck.dbusSocket, self.sanityCheck.confOptsDict)

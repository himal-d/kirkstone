...
elif [ "$XCAM_MODEL" == "SERXW3" ] || [ "$XCAM_MODEL" == "SERICAM2" ] || [ "$XCAM_MODEL" == "XHB1" ] || [ "$XCAM_MODEL" == "XHC3" ] || [ "$XCAM_MODEL" == "XHV1" ]; then
    echo "Setting environmental variables and Pre rule makefile for xCam/iCam2/DBC/XHV1"
